...
public class Test {
	public static void main(String[] args) {
		...
		System.out.println("tem area: " + c1.area() + " e perimetro: " + c1.perimetro());
		System.out.println("tem area: " + c3.area() + " e perimetro: " + c3.perimetro());
		System.out.println("c1 equals to c3? -> " + c1.equals(c3)); // True

		Quadrado q1 = new Quadrado(2);
		Quadrado q2 = new Quadrado(3, 4, 2);
		Quadrado q3 = new Quadrado(q2);
		System.out.println("tem area: " + q1.area() + " e perimetro: " + q1.perimetro());
		System.out.println("tem area: " + q3.area() + " e perimetro: " + q3.perimetro());
		...
		System.out.println("tem area: " + r1.area() + " e perimetro: " + r1.perimetro());
		System.out.println("tem area: " + r3.area() + " e perimetro: " + r3.perimetro());
