...
import aula04.Ex2.Circulo;
import aula04.Ex2.ColecaoFiguras;
import aula04.Ex2.Figura;
import aula04.Ex2.Quadrado;
import aula04.Ex2.Retangulo;
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < listaFig.length; i++) {
			System.out.printf("%2d %12s de area %6.2f compareTo(listaFig[0]) = %2d\n", i,
					listaFig[i].getClass().getSimpleName(), listaFig[i].area(), listaFig[i].compareTo(listaFig[0]));
		}
		...
		for (Figura f : listaFig)
			System.out.println(f + " -> area: " + String.format("%2.2f", f.area()) + " e perimetro: "
